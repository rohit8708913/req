...
async def not_joined(client: Client, message: Message):
    ...
    sub1 = await is_subscribed1(client, message, None)
    sub2 = await is_subscribed2(client, message, None)
    sub3 = await is_subscribed3(client, message, None)
    sub4 = await is_subscribed4(client, message, None)
