...
async def not_joined(client: Client, message: Message):
    ...
    sub1 = await is_subscribed1(client, message, FSUB_CHANNEL1)
    sub2 = await is_subscribed2(client, message, FSUB_CHANNEL2)
    sub3 = await is_subscribed3(client, message, FSUB_CHANNEL3)
    sub4 = await is_subscribed4(client, message, FSUB_CHANNEL4)
